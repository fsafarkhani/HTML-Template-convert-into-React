            ...
            <div className="row">
              ...
              <div className="col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div className="service-h-desc">
                  ...
                  <p> template offer the full spectrum of services to help organizations work better. Everything from creating standards of excellence to training your people to work in more effective ways.</p>  
