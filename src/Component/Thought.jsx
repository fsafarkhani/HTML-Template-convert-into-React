                    ...
                    <div className="container">
                        <div id="thought-desc" className="row title-bar title-bar-thought owl-carousel owl-theme">
                            ...
                            <div className="col-md-12 thought-desc">
                                <div className="heading-border bg-white" />
                                <p className="wow fadeInUp" data-wow-delay="0.4s">Ensuring quality in Pinnecs is an obsession and the high quality standards set by us are achieved through a rigorous quality assurance process. Quality assurance is performed by an independent team of trained experts for each project. </p>
                                <h6>Tom John</h6>
                            </div>
                        </div>
                    </div>
